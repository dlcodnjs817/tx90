#!/usr/bin/env python3
"""2026-08-14 세션들에서 프로젝트 관련 대화만 골라 마크다운으로 추출.

8/14: v6 joint 데이터셋·모델 구축, 트러블슈팅, 모델 이해 문답, 실시간 확장 로드맵, PPT 제작.

  python3 export_project_md_0813.py
  → ~/tx90/대화록 및 PPT/OMX_TX90_프로젝트_대화록_20260814.md
"""
...
OUT = os.path.expanduser("~/tx90/대화록 및 PPT/OMX_TX90_프로젝트_대화록_20260814.md")

SINCE = "2026-08-12T15:00"     # KST 2026-08-14 00:00 (UTC 기준)
MAX_RESULT = 2500
MAX_INPUT = 1200

# (세션 id 앞 8자, 제목) — 시작 시각 순
SESSIONS = [
    ("1a2eddd2", "v6 구축의 날 — 오프라인 IK 변환 · 재학습 · 모델 이해 문답 · 실시간 확장 정리"),
]

SKIP_CONTAINS = [
    "오늘 대화내용도 md",        # 이 추출 요청 자체
]
SKIP_EXACT = {"아", "+", ""}
...
def main():
    md = ["# OMX → TX2-90 EE Pose 전이 — 프로젝트 대화록 (2026-08-14)", ""]
